...
# бумпнута 1.0.0 → 1.1.0 в manifest.json; внеспринтовый фикс 2026-09-04
# — бот должен говорить о себе в мужском роде, версия бумпнута
# 1.1.0 → 1.2.0) — при следующем таком изменении обновляйте эту
# константу вместе с файлом, не наоборот.
