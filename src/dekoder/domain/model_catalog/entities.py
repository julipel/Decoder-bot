...
(ADR-7.3): выбранный агрегатор (настраиваемый через
`LLM_PROVIDER_BASE_URL`, Sprint 11, ADR-11.1) обычно федерирует всех
поставщиков одним HTTP-интерфейсом, поэтому дополнительный слой
трансляции не оправдан (YAGNI).
