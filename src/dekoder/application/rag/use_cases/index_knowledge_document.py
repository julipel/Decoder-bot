...
from dekoder.application.rag.commands import IndexKnowledgeDocumentCommand
...
class IndexKnowledgeDocumentUseCase:
    """Полный набор фрагментов источника заменяется целиком (04, §4 — частичное обновление не предусмотрено)."""
    ...
    def execute(self, command: IndexKnowledgeDocumentCommand) -> None:
